...
const { buildCleanupArgs, writeArgsFile } = await import(
  new URL("../../../tools/action/prepare-cleanup-args.mjs", import.meta.url).href
);
const { writeGitHubOutputs } = await import(new URL("../../../tools/action/_github-output.mjs", import.meta.url).href);
